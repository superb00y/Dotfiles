...
from gi.repository import (  # Keep Gtk for Switch, FileChooserButton, Expander, Grid
    GdkPixbuf,
    Gtk,
)
...
class HyprConfGUI(Window):
    ...
    def create_system_tab(self):
        ...
        support_label = Label(
            markup="<small>For help or to report issues, visit the <a href='https://github.com/Axenide/Ax-Shell'>GitHub repository</a></small>"
        )
